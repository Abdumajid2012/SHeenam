...
namespace Sheenam.Api.Tests.Unit.Services.Foundations.Guests
{
    ...
    {
        [Fact]
        public async Task ShouldThrowCriticalDependenceExceptionOnAddIfSqlErrorOccursAndLogItAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependenceValidationOnAddifDuplicateKeyErrorOccursAndLogItAsync()
        {
            // given
            Guest someGuest = CreateRandomGuest();
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnAddIfServiceErrorOccurstAndLogItAsync()
        {
            // given
            Guest someGuest = CreateRandomGuest();

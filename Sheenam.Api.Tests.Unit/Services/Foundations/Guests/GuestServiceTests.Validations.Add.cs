...
namespace Sheenam.Api.Tests.Unit.Services.Foundations.Guests
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionsOnAddIfGuestIsNullAndLogItAsync()
        {
            // given
        ...
        [InlineData("")]
        [InlineData(" ")]
        public async Task ShouldThrowValidationExceptionsOnAddIfGuestIsInvalidAndLogItAsync(
            string invalidText)
        {
            // given
        ...
        {
            // given
            Guest rendomGuest = CreateRandomGuest();
            Guest invalidGuest = rendomGuest;
